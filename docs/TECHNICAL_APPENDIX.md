...
#### B.1.1 Regression Performance (R² Scores)
- **ML Models Average R²:** 0.289
- **Statistical Models Average R²:** 0.317
- **Performance Difference:** ML models show -8.9% higher average R² scores
...
- **Performance Range:** R² = 0.441 to 0.999
...
- **Performance Range:** R² = 0.182 to 0.728
...
- **Performance Range:** R² = -0.971 to 0.965
...
- **Performance Range:** R² = 0.453 to 0.787
...
- **Performance Range:** R² = 0.453 to 0.999
